      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="fixed bottom-6 right-6">
          <a 
            ...
            className="inline-flex items-center cyber-card px-4 py-2 rounded-full text-sm text-white hover:text-cyber-blue transition-all duration-300 glow-border animate-pulse-glow"
          >
            More AI Tools
          </a>
        </div>
